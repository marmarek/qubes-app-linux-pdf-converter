...
document, spreadsheet, and presentation conversion for DOC, DOCX, ODT, XLSX,
ODS, PPTX, and ODP files. Those formats require LibreOffice to be installed in
the relevant template. It also supports common video formats by re-encoding them
